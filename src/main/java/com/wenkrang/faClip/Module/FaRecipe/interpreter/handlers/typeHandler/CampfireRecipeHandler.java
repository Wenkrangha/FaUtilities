...
public class CampfireRecipeHandler implements FaReHandler {
    ...
    public void handle(FaData faData, FaRecipe faRecipe, FaRecipeInstance faRecipeInstance) {
        ...
        if (type != null && type.equalsIgnoreCase("campfire")) {
            ...
            int time = faData.getInt("time", 600);

            faRecipe.recipe = new CampfireRecipe(
